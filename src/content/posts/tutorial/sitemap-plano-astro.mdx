---
image: ../../../assets/images/posts/tutorial/sitemap-plano.png
imageAlt: "Ilustración técnica de un sitemap plano frente a uno indexado en Astro. Muestra un sitemap.xml limpio y brillante con un check verde."
title: "Sitemap Plano en Astro: El truco para Google Search Console"
copy: "Google Search Console ama los sitemaps planos. Aquí te enseño cómo forzarlo en Astro con un simple script post-build."
date: 2026-04-22
category: Tutorial
...
Al implementar esto, Google Search Console suele pasar del estado "No se pudo obtener" a "Correcto" casi de inmediato. Es un pequeño ajuste técnico que hace que tu SEO sea mucho más predecible y eficiente.
